...
public class TodoLyLogout {
    ...
    public void loginTodoLy(){
        ...
        //2) Set Email
        driver.findElement(By.xpath("//input[@name='ctl00$MainContent$LoginControl1$TextBoxEmail']")).sendKeys("patrick@upb.com");
        //3) Set Password
        ...
        //Logout
        driver.findElement(By.xpath("//input[@id='ctl00_HeaderTopControl1_LinkButtonLogout']")).click();
